    ...
    def __init__(self):
        ...
        with tf.Graph().as_default():
            ...
            with self._sess.as_default():
                ...
                self.load_roll_variables(os.path.realpath(
                    "/mnt/drive/Amir/Thesis/git/thesis/code/integration/deepgaze/model/roll/cnn_cccdd_30k.tf"))
                self.load_pitch_variables(os.path.realpath(
                    "/mnt/drive/Amir/Thesis/git/thesis/code/integration/deepgaze/model/pitch/cnn_cccdd_30k.tf"))
                self.load_yaw_variables(os.path.realpath(
                    "/mnt/drive/Amir/Thesis/git/thesis/code/integration/deepgaze/model/yaw/cnn_cccdd_30k.tf"))
